...
var getAllBooks = function (limit) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Book_1.default.find({}).limit(limit)];
...
var getBookById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Book_1.default.findById(id)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
var createBook = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Book_1.default.create({ title: title, author: author, description: description })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Book_1.default.findByIdAndUpdate(id, book, { new: true })];
...
var deleteBook = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Book_1.default.findByIdAndDelete(id)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
